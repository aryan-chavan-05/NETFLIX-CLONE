...
const Navbar = () => {
  ...
  return (
    <div  className='navbar fixed top-0 left-0 w-full h-20 flex items-center justify-between px-12 z-50'>
      <div className=' flex items-center justify-center gap-10'>
        <img className='w-25 h-7' src={logo} alt="" />
        ...
        <img className='h-6 w-6' src={bell} alt="" />
         <div className='relative'>
          <div className='flex items-center gap-3 cursor-pointer' onClick={() => setShowMenu(!showMenu)}>
            ...
            <img className={`${showMenu ? "rotate-180" : ""} transition`} src={caret} alt="" />
          </div>
          {showMenu && (
